...
; 0000 0050 // Function: Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0051 DDRC=(0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x7,R30
; 0000 0052 // State: Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0053 PORTC=(0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x8,R30
; 0000 0054 
...
; 0000 0061 TCCR0A=(0<<COM0A1) | (0<<COM0A0) | (0<<COM0B1) | (0<<COM0B0) | (0<<WGM01) | (0<<WGM00);
	OUT  0x24,R30
; 0000 0062 TCCR0B=(0<<WGM02) | (0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x25,R30
...
; 0000 0069 // Clock value: 250.000 kHz
; 0000 006A // Mode: CTC top=OCR1A
...
; 0000 0074 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	STS  128,R30
; 0000 0075 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (1<<CS11) | (1<<CS10);
	LDI  R30,LOW(11)
	STS  129,R30
...
; 0000 0083 // OC2A output: Disconnected
; 0000 0084 // OC2B output: Disconnected
; 0000 0085 ASSR=(0<<EXCLK) | (0<<AS2);
	STS  182,R30
; 0000 0086 TCCR2A=(0<<COM2A1) | (0<<COM2A0) | (0<<COM2B1) | (0<<COM2B0) | (0<<WGM21) | (0<<WGM20);
	STS  176,R30
; 0000 0087 TCCR2B=(0<<WGM22) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	STS  177,R30
...
; 0000 008D TIMSK0=(0<<OCIE0B) | (0<<OCIE0A) | (0<<TOIE0);
	STS  110,R30
; 0000 008E 
; 0000 008F // Timer/Counter 1 Interrupt(s) initialization
; 0000 0090 TIMSK1=(0<<ICIE1) | (0<<OCIE1B) | (1<<OCIE1A) | (0<<TOIE1);
	LDI  R30,LOW(2)
	STS  111,R30
; 0000 0091 
; 0000 0092 // Timer/Counter 2 Interrupt(s) initialization
; 0000 0093 TIMSK2=(0<<OCIE2B) | (0<<OCIE2A) | (0<<TOIE2);
	LDI  R30,LOW(0)
	STS  112,R30
; 0000 0094 
; 0000 0095 // External Interrupt(s) initialization
; 0000 0096 // INT0: On
; 0000 0097 // INT0 Mode: Any change
; 0000 0098 // INT1: On
; 0000 0099 // INT1 Mode: Any change
; 0000 009A // Interrupt on any change on pins PCINT0-7: Off
; 0000 009B // Interrupt on any change on pins PCINT8-14: Off
; 0000 009C // Interrupt on any change on pins PCINT16-23: Off
; 0000 009D EICRA=(0<<ISC11) | (1<<ISC10) | (0<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(5)
	STS  105,R30
; 0000 009E EIMSK=(1<<INT1) | (1<<INT0);
	LDI  R30,LOW(3)
	OUT  0x1D,R30
; 0000 009F EIFR=(1<<INTF1) | (1<<INTF0);
	OUT  0x1C,R30
...
; 0000 00A7 // USART Baud Rate: 57600 (Double Speed Mode)
; 0000 00A8 UCSR0A=(0<<RXC0) | (0<<TXC0) | (0<<UDRE0) | (0<<FE0) | (0<<DOR0) | (0<<UPE0) | (1<<U2X0) | (0<<MPCM0);
	LDI  R30,LOW(2)
	STS  192,R30
...
; 0000 00B4 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 00B5 ADCSRB=(0<<ACME);
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 00B6 // Digital input buffer on AIN0: On
; 0000 00B7 // Digital input buffer on AIN1: On
; 0000 00B8 DIDR1=(0<<AIN0D) | (0<<AIN1D);
	STS  127,R30
; 0000 00B9 
...
; 0000 00C4 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	STS  188,R30
; 0000 00C5 
; 0000 00C6 // Globally enable interrupts
; 0000 00C7 #asm("sei")
	SEI
; 0000 00C8 
; 0000 00C9 DDRB=1<<5;
