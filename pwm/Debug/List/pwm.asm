...
; 0000 0035 // Function: Bit7=In Bit6=Out Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0036 DDRD=(0<<DDD7) | (1<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(64)
	OUT  0xA,R30
; 0000 0037 // State: Bit7=T Bit6=0 Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 003C // Clock value: 2000.000 kHz
; 0000 003D // Mode: Fast PWM top=0xFF
; 0000 003E // OC0A output: Non-Inverted PWM
; 0000 003F // OC0B output: Disconnected
; 0000 0040 // Timer Period: 0.128 ms
; 0000 0041 // Output Pulse(s):
; 0000 0042 // OC0A Period: 0.128 ms Width: 0.016063 ms
; 0000 0043 TCCR0A=(1<<COM0A1) | (0<<COM0A0) | (0<<COM0B1) | (0<<COM0B0) | (1<<WGM01) | (1<<WGM00);
	LDI  R30,LOW(131)
	OUT  0x24,R30
; 0000 0044 TCCR0B=(0<<WGM02) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(2)
	OUT  0x25,R30
; 0000 0045 TCNT0=0x00;
	LDI  R30,LOW(0)
	OUT  0x26,R30
; 0000 0046 OCR0A=0x20;
	LDI  R30,LOW(32)
	OUT  0x27,R30
...
; 0000 0082 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	STS  193,R30
; 0000 0083 
...
; 0000 008A ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 008B ADCSRB=(0<<ACME);
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 008C // Digital input buffer on AIN0: On
; 0000 008D // Digital input buffer on AIN1: On
; 0000 008E DIDR1=(0<<AIN0D) | (0<<AIN1D);
	STS  127,R30
; 0000 008F 
